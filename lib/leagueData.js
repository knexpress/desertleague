...
export const defaultFixtures = [
  ...
  makeFixture("M3", "Wed, Apr 15", "Jawad XI vs Venom Squad", "9:00 PM"),
  makeFixture("M4", "Thu, Apr 16", "Al Ain United vs Titans XI", "9:00 PM"),
  makeFixture("M5", "Fri, Apr 17", "Avengers XI vs Venom Squad", "9:00 PM"),
  makeFixture("M6", "Mon, Apr 20", "Jawad XI vs Titans XI", "9:00 PM"),
  makeFixture("M7", "Thu, Apr 23", "Titans XI vs Avengers XI", "9:00 PM"),
  makeFixture("M8", "Fri, Apr 24", "Al Ain United vs Venom Squad", "9:00 PM"),
  makeFixture("M9", "Mon, Apr 27", "Jawad XI vs Al Ain United", "9:00 PM"),
  makeFixture("M10", "Tue, Apr 28", "Venom Squad vs Titans XI (Reverse)", "9:00 PM"),
  makeFixture("M11", "Fri, May 1", "Avengers XI vs Al Ain United (Reverse)", "9:00 PM"),
  makeFixture("M12", "Mon, May 4", "Jawad XI vs Avengers XI (Reverse)", "9:00 PM"),
  makeFixture("M13", "Thu, May 7", "Titans XI vs Al Ain United (Reverse)", "9:00 PM"),
  makeFixture("M14", "Fri, May 8", "Venom Squad vs Avengers XI (Reverse)", "9:00 PM"),
  makeFixture("M15", "Mon, May 11", "Jawad XI vs Venom Squad (Reverse)", "9:00 PM"),
  makeFixture("M16", "Wed, May 13", "Jawad XI vs Titans XI (Reverse)", "9:00 PM"),
  makeFixture("M17", "Thu, May 14", "Avengers XI vs Titans XI (Reverse)", "9:00 PM"),
  makeFixture("M18", "Sun, May 17", "Venom Squad vs Al Ain United (Reverse)", "9:00 PM"),
  makeFixture("M19", "Mon, May 18", "Al Ain United vs Jawad XI (Reverse)", "9:00 PM"),
  makeFixture("M20", "Thu, May 21", "Avengers XI vs Venom Squad (Reverse)", "9:00 PM")
];
