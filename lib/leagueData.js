...
export const defaultFixtures = [
  ...
  makeFixture("M2", "Fri, Apr 10", "Al Ain United vs Avengers XI", "9:00 PM"),
  makeFixture("M3", "Mon, Apr 14", "Jawad XI vs Venom Squad", "9:00 PM"),
  makeFixture("M4", "Tue, Apr 15", "Al Ain United vs Titans XI", "9:00 PM"),
  makeFixture("M5", "Fri, Apr 18", "Avengers XI vs Venom Squad", "9:00 PM"),
  makeFixture("M6", "Mon, Apr 21", "Jawad XI vs Titans XI", "9:00 PM"),
  makeFixture("M7", "Thu, Apr 24", "Titans XI vs Avengers XI", "9:00 PM"),
  makeFixture("M8", "Fri, Apr 25", "Al Ain United vs Venom Squad", "9:00 PM"),
  makeFixture("M9", "Mon, Apr 28", "Jawad XI vs Al Ain United", "9:00 PM"),
  makeFixture("M10", "Tue, Apr 29", "Venom Squad vs Titans XI (Reverse)", "9:00 PM"),
  makeFixture("M11", "Fri, May 2", "Avengers XI vs Al Ain United (Reverse)", "9:00 PM"),
  makeFixture("M12", "Mon, May 5", "Jawad XI vs Avengers XI (Reverse)", "9:00 PM"),
  makeFixture("M13", "Thu, May 8", "Titans XI vs Al Ain United (Reverse)", "9:00 PM"),
  makeFixture("M14", "Fri, May 9", "Venom Squad vs Avengers XI (Reverse)", "9:00 PM"),
  makeFixture("M15", "Mon, May 12", "Jawad XI vs Venom Squad (Reverse)", "9:00 PM"),
  makeFixture("M16", "Wed, May 14", "Jawad XI vs Titans XI (Reverse)", "9:00 PM"),
  makeFixture("M17", "Thu, May 15", "Avengers XI vs Titans XI (Reverse)", "9:00 PM"),
  makeFixture("M18", "Sun, May 18", "Venom Squad vs Al Ain United (Reverse)", "9:00 PM"),
  makeFixture("M19", "Mon, May 19", "Al Ain United vs Jawad XI (Reverse)", "9:00 PM"),
  makeFixture("M20", "Thu, May 22", "Avengers XI vs Venom Squad (Reverse)", "9:00 PM")
];
